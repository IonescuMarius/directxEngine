...
typedef void (*UPDATESCENE)(LPVOID pContext, dxScene * pScene, float TimeScale);
...
public:
    ...
    void                AddSceneCallback    ( UPDATESCENE pFunc, LPVOID pContext );
    void                AddCameraCallback    ( UPDATECAMERA pFunc, LPVOID pContext );
    void                RemoveSceneCallback ( UPDATESCENE pFunc, LPVOID pContext );
    ...
    void                SetVolumeInfo      ( const VOLUME_INFO2& Volume );
    const VOLUME_INFO2&  GetVolumeInfo      ( ) const;
